      ...
      children: [
        {
          path: "/button",
          name: "button",
          component: async () => import('./Button.zh-CN.48ec3934.js')
        },
        {
          path: "/layout",
          name: "layout",
          component: async () => import('./layout.bddf71f2.js')
        },
        {
          path: "/container",
          name: "container",
          component: async () => import('./Container.zh-CN.78ce33c9.js')
        },
        {
          path: "/icon",
          name: "icon",
          component: async () => import('./icon.7b133d89.js')
        },
        {
          path: "/menu",
          name: "menu",
          component: async () => import('./menu.4da48e8d.js')
        },
        {
          path: "/popover",
          name: "popover",
          component: async () => import('./popover.0bd98139.js')
        }
      ]
    }
  ]
...
export { Button as B, ElRow as E, Fragment as F, Icon as I, Popover as P, _toDisplayString as _, ElCol as a, createVNode as b, createBlock as c, defineComponent as d, createTextVNode as e, renderList as f, ElMenu as g, ElMenuItem as h, ElSubmenu as i, ElMenuItemGroup as j, openBlock as o, resolveComponent as r, script$2 as s, withCtx as w };
