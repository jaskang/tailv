...
var css_248z$6 = ".el-popover{position:absolute;background:#fff;min-width:150px;border-radius:4px;border:1px solid #ebeef5;padding:12px;z-index:2000;color:#606266;line-height:1.4;text-align:justify;font-size:14px;box-shadow:0 2px 12px 0 rgba(0,0,0,.1);word-break:break-all}.el-popover--plain{padding:18px 20px}.el-popover__title{color:#303133;font-size:16px;line-height:1;margin-bottom:12px}.el-popover:focus,.el-popover:focus:active,.el-popover__reference:focus:hover,.el-popover__reference:focus:not(.focusing){outline-width:0}";
            injectCss(css_248z$6,'components_Popover_Popover.scss');
      ...
      children: [
        {
          path: "/button",
          name: "button",
          component: async () => import('./Button.zh-CN.aff16a2a.js')
        },
        {
          path: "/layout",
          name: "layout",
          component: async () => import('./Layout.8d48b1b5.js')
        },
        {
          path: "/container",
          name: "container",
          component: async () => import('./Container.zh-CN.4d5e24c5.js')
        },
        {
          path: "/icon",
          name: "icon",
          component: async () => import('./Icon.94ef0b02.js')
        },
        {
          path: "/menu",
          name: "menu",
          component: async () => import('./menu.8f20a8ec.js')
        },
        {
          path: "/popover",
          name: "popover",
          component: async () => import('./popover.212bb43b.js')
        }
      ]
    }
  ]
...
export { Button as B, ElRow as E, Fragment as F, Popover as P, _toDisplayString as _, ElCol as a, ElMenu as b, ElMenuItem as c, defineComponent as d, ElSubmenu as e, ElMenuItemGroup as f, createBlock as g, createVNode as h, createTextVNode as i, openBlock as o, resolveComponent as r, script$2 as s, withCtx as w };
