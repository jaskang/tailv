...
/* PrismJS 1.20.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+less+typescript */
...
const router = createRouter({
  ...
  routes: [{
    ...
    children: [{
      path: "/button",
      name: "button",
      component: async () => import('./button-45fd7826.js')
    }, {
      path: "/layout",
      name: "layout",
      component: async () => import('./layout-7f11f12a.js')
    }, {
      path: "/container",
      name: "container",
      component: async () => import('./container-3a1e2fbe.js')
    }, {
      path: "/icon",
      name: "icon",
      component: async () => import('./icon-d759b975.js')
    }]
  }]
});
...
export { Fragment as F, _toDisplayString as _, createVNode as a, renderSlot as b, createBlock as c, defineComponent as d, createTextVNode as e, createCommentVNode as f, script$5 as g, resolveComponent as h, index as i, index$1 as j, script$1 as k, script$1$1 as l, script$2 as m, script$3 as n, openBlock as o, script$4 as p, script$7 as q, reactive as r, script$6 as s, toRefs as t, renderList as u, withCtx as w };
