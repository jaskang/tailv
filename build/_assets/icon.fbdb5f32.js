import { d as defineComponent, x as script$7, a as script$5, r as resolveComponent, c as createBlock, b as createVNode, w as withCtx, o as openBlock, y as renderList, F as Fragment, e as createTextVNode, _ as _toDisplayString } from './index.5446da28.js';
          ...
          (openBlock(true), createBlock(Fragment, null, renderList(_ctx.icons, (name) => {
            return (openBlock(), createBlock("li", { key: name }, [
              createVNode("span", null, [
                ...
                createVNode("span", _hoisted_6, _toDisplayString('el-icon-' + name), 1 /* TEXT */)
              ])
            ]))
          }), 128 /* KEYED_FRAGMENT */))
        ])
