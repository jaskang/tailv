...
const style = tv({
  slots: {
    ...
    thumb: tw`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition-all`,
  },
  variants: {
    enabled: {
      true: {
    ...
    disabled: {
      true: {
        base: tw`pointer-events-none opacity-50 cursor-not-allowed`,
      },
      false: {
        base: tw``,
      },
