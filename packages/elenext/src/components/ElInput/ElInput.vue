<template>
  <div :class="cls" @mouseenter="hovering = true" @mouseleave="hovering = false">
...
export default defineComponent({
  ...
  props: {
    ...
    resize: { type: String, default: undefined },
  ...
  setup(props: ElInputProps, { slots, emit }) {
    const { from } = useElForm();
    const size = computed(() => props.size || from.size);
    const disabled = computed(() => props.disabled || from.disabled);
